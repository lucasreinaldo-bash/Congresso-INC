...
public class PalestranteInternacional extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_palestrantes_internacionais);
        ...
        btn_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PalestranteInternacional.this, Menu.class);
        ...
        btn_voltar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PalestranteInternacional.this, Palestrante.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter = new MyAdapter(PalestranteInternacional.this,list);
                recyclerView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(PalestranteInternacional.this, "Opsss.... Something is wrong", Toast.LENGTH_SHORT).show();
            }
        });
